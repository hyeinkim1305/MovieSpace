      ...
      <section class="clearfix">
        ...
        <div id="modal-wrapper1" class="modal row">
          ...
          <form class="modal-content1 animate">
            <div class="project-container d-inline">
              <div class="project-img-container d-inline" onclick="document.getElementById('modal-wrapper1').style.display='block'">
                <img :src="'https://image.tmdb.org/t/p/w500' + movies[22].poster_path" alt="project image">
              </div>
            </div>
            <div class="project-container d-inline">
              <div class="project-img-container d-inline" onclick="document.getElementById('modal-wrapper1').style.display='block'">
            ...
            <div class="project-container d-inline">
              <div class="project-img-container" onclick="document.getElementById('modal-wrapper1').style.display='block'">
                <img :src="'https://image.tmdb.org/t/p/w500' + movies[62].poster_path" alt="project image">
              </div>
            </div>
            <div class="project-container d-inline">
              <div class="project-img-container d-inline" onclick="document.getElementById('modal-wrapper1').style.display='block'">
                <img :src="'https://image.tmdb.org/t/p/w500' + movies[38].poster_path" alt="project image">
              </div>
            </div>
            <button class="project_submit" type="submit">Submit</button>
          </form>
